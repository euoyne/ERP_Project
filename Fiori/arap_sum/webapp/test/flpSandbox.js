		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Belnr ARAP sum",
									"targetURL": "#cl3syncyoungfiarapsumarapsum-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungfiarapsumarapsum-display": {
								"semanticObject": "cl3syncyoungfiarapsumarapsum",
								"action": "display",
								"description": "Belnr ARAP sum",
								"title": "Belnr ARAP sum",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.fi.arapsum.arapsum",
									"url": sap.ui.require.toUrl("cl3/syncyoung/fi/arapsum/arapsum")
								}
							}
						}
					}
