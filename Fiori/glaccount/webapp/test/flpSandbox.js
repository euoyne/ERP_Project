		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "create glaccount",
									"targetURL": "#cl3syncyoungfiglaccountglaccount-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungfiglaccountglaccount-display": {
								"semanticObject": "cl3syncyoungfiglaccountglaccount",
								"action": "display",
								"description": "create glaccount",
								"title": "create glaccount",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.fi.glaccount.glaccount",
									"url": sap.ui.require.toUrl("cl3/syncyoung/fi/glaccount/glaccount")
								}
							}
						}
					}
